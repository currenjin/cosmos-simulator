...
const COPY = {
  ko: {
    ...
    "sim.constellationSelect": "별자리 선택",
    "sim.scaleTitle": "스케일 점프",
    "sim.scaleSky": "하늘",
    "sim.scaleSolar": "태양계",
    "sim.scaleGalaxy": "우리은하",
    "sim.scaleLocal": "국부은하군",
    "sim.scaleTourStart": "스케일 투어 시작",
    "sim.scaleTourStop": "투어 중지",
    ...
    "sim.time": "시간",
    "sim.speed": "배속",
    "sim.presetTitle": "시간 프리셋",
    "sim.presetDay": "24시간 재생",
    "sim.presetYear": "1년 재생",
    "sim.presetStop": "정지",
    "sim.search": "천체 찾기",
    "sim.searchBtn": "찾기",
    "sim.live": "현재 시간 실시간",
    ...
    "kepler.areaLatest": "최근 면적 ΔA",
    "kepler.areaAvg": "평균 ΔA",
    "kepler.areaSpread": "편차(CV)",
    "kepler.areaWindow": "샘플 수",
    "kepler.simSpeed": "시뮬레이션 속도",
    "kepler.pause": "일시정지",
    "kepler.resume": "재생",
    "kepler.step": "한 스텝",
    "kepler.k3": "3) 케플러 3법칙",
  ...
  en: {
    ...
    "sim.constellationSelect": "Constellation",
    "sim.scaleTitle": "Scale Jump",
    "sim.scaleSky": "Sky",
    "sim.scaleSolar": "Solar System",
    "sim.scaleGalaxy": "Milky Way",
    "sim.scaleLocal": "Local Group",
    "sim.scaleTourStart": "Start Scale Tour",
    "sim.scaleTourStop": "Stop Tour",
    ...
    "sim.time": "Time",
    "sim.speed": "Speed",
    "sim.presetTitle": "Time Presets",
    "sim.presetDay": "24h Cycle",
    "sim.presetYear": "1y Cycle",
    "sim.presetStop": "Stop",
    "sim.search": "Find Object",
    "sim.searchBtn": "Find",
    "sim.live": "Live Time",
    ...
    "kepler.areaLatest": "Latest swept area ΔA",
    "kepler.areaAvg": "Average ΔA",
    "kepler.areaSpread": "Spread (CV)",
    "kepler.areaWindow": "Sample count",
    "kepler.simSpeed": "Simulation speed",
    "kepler.pause": "Pause",
    "kepler.resume": "Resume",
    "kepler.step": "Step",
